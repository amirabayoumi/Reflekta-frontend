            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 transform group-hover:-translate-y-2 group-hover:shadow-lg h-full">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Join us for cultural events, workshops, and meetups to
                  celebrate diversity and foster connections.
                </p>
          ...
          <Link href="/community-hub/jobs" className="group">
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 transform group-hover:-translate-y-2 group-hover:shadow-lg h-full">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Discover job opportunities and internships tailored for
          ...
          <Link href="/community-hub/stories" className="group">
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 transform group-hover:-translate-y-2 group-hover:shadow-lg h-full">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Read inspiring stories from community members and share your
                  own journey.
                </p>
                <div className="mt-4 flex justify-between items-center">
